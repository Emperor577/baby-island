                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong>Наши услуги</strong> редактировать
                        </div>
                                    ...
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">Загаловок</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="title_ru" value="{{ $service->translate('ru')->title }}" class="form-control">
                                            </div>
                                        </div>
{{--                                        <div class="row form-group">--}}
{{--                                            <div class="col col-md-3">--}}
...
{{--                                            </div>--}}
{{--                                            <div class="col-12 col-md-9">--}}
{{--                                                <input type="text" id="text-input" name="text_ru" value="{{ $service->translate('ru')->text }}" class="form-control">--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
                                    </div>
                                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="title_uz" value="{{ $service->translate('uz')->title }}" class="form-control">
                                            </div>
                                        </div>
{{--                                        <div class="row form-group">--}}
{{--                                            <div class="col col-md-3">--}}
...
{{--                                            </div>--}}
{{--                                            <div class="col-12 col-md-9">--}}
{{--                                                <input type="text" id="text-input" name="text_uz" value="{{ $service->translate('uz')->text }}" class="form-control">--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        @if($service->photo != null || $service->photo != '')
                                            <span class="delete-image" id="delete-icon" onclick="deleteFunc({{ $service->id }})"><i class="fa fa-times"></i></span>
                                            <img id="my_image" src="{{ asset('storage/service/'. $service->photo) }}" alt="" height="200px">
                                        @endif
                                        <input type="file" id="file-input" name="photo" class="form-control-file">
                                    </div>
                                </div>
                                <div class="mt-3">
                                    <a href="{{ route('admin.service.index') }}" class="btn btn-warning color-white"><i class="fa fa-long-arrow-left"></i> Back</a>
